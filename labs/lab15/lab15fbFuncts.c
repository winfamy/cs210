...
int readData(int attempts[], int yards[], int touchdowns[]) {
    ...
    inFile = fopen("fbData.txt", "r"); // use this for working in CLion (comment when you submit)
    //inFile = fopen("../labs/lab14/fbData.txt", "r"); // use this for submission (UN-comment when you submit)
